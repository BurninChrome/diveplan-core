...
const struct compartment_constants zh_l16C[ZH_L16_NR_COMPARTMENTS] = {
    ...
    {   27.0f, 0.6200f, 0.8126f,   10.21f,  0.9220f, 0.7582f }, /*  5  */
    {   38.3f, 0.5043f, 0.8434f,   14.48f,  0.8205f, 0.7957f }, /*  6  */
    {   54.3f, 0.4410f, 0.8693f,   20.53f,  0.7305f, 0.8279f }, /*  7  */
    {   77.0f, 0.4000f, 0.8910f,   29.11f,  0.6502f, 0.8553f }, /*  8  */
    {  109.0f, 0.3750f, 0.9092f,   41.20f,  0.5950f, 0.8757f }, /*  9  */
    {  146.0f, 0.3500f, 0.9222f,   55.19f,  0.5545f, 0.8903f }, /* 10  */
    {  187.0f, 0.3295f, 0.9319f,   70.69f,  0.5333f, 0.8997f }, /* 11  */
    {  239.0f, 0.3065f, 0.9403f,   90.34f,  0.5189f, 0.9073f }, /* 12  */
    {  305.0f, 0.2835f, 0.9477f,  115.29f,  0.5181f, 0.9122f }, /* 13  */
    {  390.0f, 0.2610f, 0.9544f,  147.42f,  0.5176f, 0.9171f }, /* 14  */
    {  498.0f, 0.2480f, 0.9602f,  188.24f,  0.5172f, 0.9217f }, /* 15  */
