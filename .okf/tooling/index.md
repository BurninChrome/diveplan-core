...
* [Reference vectors and the regression baseline](reference-vectors.md) - two safety nets: 475 conformance checks derived from theory, and a change-detector over the 39 real dives. **Start here** — the older suite checks the library against itself.
